        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    // Get the currentDialogueDataIndex of the material used by the current character.
                    int materialIndex = textInfo.characterInfo[i].materialReferenceIndex;

                    // Get the currentDialogueDataIndex of the first vertex used by this text element.
                    ...
                    // Add modified scale and currentDialogueDataIndex
